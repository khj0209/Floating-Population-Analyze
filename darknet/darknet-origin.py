...
def print_detections(detections, coordinates=False):
    print("\nMYYYYYYYYYYYYYYYYYY Objects:")
    for label, confidence, bbox in detections:
        x, y, w, h = bbox
        if coordinates:
            print("please ! {}: {}%    (left_x: {:.0f}   top_y:  {:.0f}   width:   {:.0f}   height:  {:.0f})".format(label, confidence, x, y, w, h))
        else:
            print("please ! {}: {}%".format(label, confidence))
...
def draw_boxes(detections, image, colors):
    ...
    for label, confidence, bbox in detections:
        ...
        cv2.putText(image, "please....please..{} [{:.2f}]".format(label, float(confidence)),
