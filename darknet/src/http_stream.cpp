...
void send_json_my(size_t class_size, char** names, unsigned int* classes_counts, int port, int timeout)
{
    try {
        char* send_buf = detection_to_json_my(class_size, names, classes_counts);
